...
hl.window_rule({match = {class = "SuperHexagon", title = "Super Hexagon"}, confine_pointer = true})
...
hl.window_rule({match = {class = "Staged-app", title = "Staged"}, float = true})
...
hl.window_rule({match = {class = "kitty-floating"}, size = "980 640", float = true, center = true})
